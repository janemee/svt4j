...
public class WXPay {
    ...
    public Map<String, String> fillRequestData(Map<String, String> reqData) throws Exception {
        reqData.put("appid", WeiXinConfig.appid);
        reqData.put("mch_id", WeiXinConfig.mch_id);
        reqData.put("nonce_str", WXPayUtil.generateNonceStr());
        reqData.put("sign_type", WeiXinConfig.sign_type_HMACSHA256_);
        ...
        reqData.put("sign", WXPayUtil.generateSignature(reqData, WeiXinConfig.key, WXPayConstants.SignType.HMACSHA256));
        return reqData;
    }
