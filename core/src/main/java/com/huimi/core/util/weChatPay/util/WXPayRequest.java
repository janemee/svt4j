...
import static com.huimi.core.util.weChatPay.util.WXPayConstants.USER_AGENT;
...
public class WXPayRequest {
    ...
    public String requestWithoutCert(String urlSuffix, String uuid, String data, boolean autoReport) throws Exception {
        return this.request(urlSuffix, uuid, data, WeiXinConfig.DEFAULT_CONNECT_TIMEOUT_MS, WeiXinConfig.DEFAULT_READ_TIMEOUT_MS, false, autoReport);
    }
    ...
    public String requestWithCert(String urlSuffix, String uuid, String data, boolean autoReport) throws Exception {
        return this.request(urlSuffix, uuid, data, WeiXinConfig.DEFAULT_CONNECT_TIMEOUT_MS,  WeiXinConfig.DEFAULT_READ_TIMEOUT_MS, true, autoReport);
    }
