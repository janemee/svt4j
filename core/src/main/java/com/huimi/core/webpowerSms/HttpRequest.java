...
public class HttpRequest {
	 ...
	 * @param type 请求方式,POST,GET,推荐POST
	 */
	public String sendSms(String type ,String regCode, String regPasswod,String phone,String content) {
...
//		String content = signature+" 短信验证码:" +  (1000 + random.nextInt(9000));		//短信内容,请严格按照客服定义的模板生成短信内容,否则发送将失败(含有中文，特殊符号等非ASCII码的内容，用户必须保证其为UTF-8编码格式)
		try {
