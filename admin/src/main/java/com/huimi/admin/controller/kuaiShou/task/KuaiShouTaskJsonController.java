...
public class KuaiShouTaskJsonController extends BaseController {
    @Resource
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(KuaiShouTaskJsonController.class);
    ...
    public DtGrid listJson(HttpServletRequest request, int rows, int page) throws Exception {
        ...
        whereSql.append(" and platform  = '").append(EnumConstants.PLAT_FROM_TYPE.KUAISHOU.value).append("' ");
