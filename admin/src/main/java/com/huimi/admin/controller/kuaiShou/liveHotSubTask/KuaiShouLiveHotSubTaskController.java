package com.huimi.admin.controller.kuaiShou.liveHotSubTask;
 ...
 */
@Controller
@RequestMapping(BaseController.BASE_URI+"/kuaiShou")
public class KuaiShouLiveHotSubTaskController extends BaseController {
    @Resource
    ...
    //平台类型
    private String  platform = EnumConstants.PLAT_FROM_TYPE.KUAISHOU.value;
    ...
    public ModelAndView list(String ids) {
        ...
        modelAndView.setViewName("kuaiShou/task/subHotTaskList");
        return modelAndView;
    }
    ...
    public ModelAndView superHeat() {
        ...
        modelAndView.addObject("equipmentGroups", equipmentGroups);
        modelAndView.addObject("commentTemplate", commentTemplate);
        modelAndView.setViewName("kuaiShou/task/superHeat");
        return modelAndView;
    }
    ...
    public ModelAndView interaction(String[] taskContent) {
        ...
        modelAndView.addObject("equipmentList", equipmentList);
        modelAndView.setViewName("kuaiShou/task/interaction");
        return modelAndView;
    }
    ...
    public ModelAndView fans() {
        ...
        modelAndView.addObject("equipmentList", equipmentList);
        modelAndView.addObject("equipmentGroups", equipmentGroups);
        modelAndView.setViewName("kuaiShou/task/fans");
        return modelAndView;
    }
    ...
    public ModelAndView makerList() {
        ...
        modelAndView.addObject("equipmentList", equipmentList);
        modelAndView.addObject("equipmentGroups", equipmentGroups);
        modelAndView.setViewName("kuaiShou/task/makeList");
        return modelAndView;
    }
    ...
    public ModelAndView redEnvelope() {
        ...
        modelAndView.addObject("equipmentList", equipmentList);
        modelAndView.addObject("equipmentGroups", equipmentGroups);
        modelAndView.setViewName("kuaiShou/task/redEnvelope");
        return modelAndView;
    }
    ...
    public ModelAndView lookShopping() {
        ...
        modelAndView.addObject("equipmentList", equipmentList);
        modelAndView.addObject("equipmentGroups", equipmentGroups);
        modelAndView.setViewName("kuaiShou/task/lookShopping");
        return modelAndView;
    }
    ...
    public ModelAndView giveGift() {
        ...
        modelAndView.addObject("equipmentList", equipmentList);
        modelAndView.addObject("equipmentGroups", equipmentGroups);
        modelAndView.setViewName("kuaiShou/task/giveGift");
        return modelAndView;
    }
    ...
    public ModelAndView fansGroup() {
        ...
        modelAndView.addObject("equipmentList", equipmentList);
        modelAndView.addObject("equipmentGroups", equipmentGroups);
        modelAndView.setViewName("kuaiShou/task/fansGroup");
        return modelAndView;
    }
    ...
    public ModelAndView followPk() {
        ...
        modelAndView.addObject("equipmentList", equipmentList);
        modelAndView.addObject("equipmentGroups", equipmentGroups);
        modelAndView.setViewName("kuaiShou/task/followPk");
        return modelAndView;
    }
    ...
    public ModelAndView insaneClick() {
        ...
        modelAndView.addObject("equipmentList", equipmentList);
        modelAndView.addObject("equipmentGroups", equipmentGroups);
        modelAndView.setViewName("kuaiShou/task/insaneClick");
        return modelAndView;
    }
    ...
    public ModelAndView follow() {
        ...
        modelAndView.addObject("equipmentList", equipmentList);
        modelAndView.addObject("equipmentGroups", equipmentGroups);
        modelAndView.setViewName("kuaiShou/task/follow");
        return modelAndView;
    }
    ...
    public ModelAndView grabFuBag() {
        ...
        modelAndView.addObject("equipmentList", equipmentList);
        modelAndView.addObject("equipmentGroups", equipmentGroups);
        modelAndView.setViewName("kuaiShou/task/grabFuBag");
        return modelAndView;
    }
    ...
    public ModelAndView overSubTask() {
        ...
        modelAndView.addObject("equipmentList", equipmentList);
        modelAndView.addObject("equipmentGroups", equipmentGroups);
        modelAndView.setViewName("kuaiShou/task/overSubTask");
        return modelAndView;
    }
    ...
    public ModelAndView equipmentSome(String taskId) {
        ...
        modelAndView.setViewName("kuaiShou/task/equipmentSome");
        return modelAndView;
    }
    ...
    public ModelAndView equipmentGroupSome(String taskId) {
        ...
        modelAndView.addObject("taskId", taskId);
        modelAndView.setViewName("kuaiShou/task/equipmentGroupSome");
        return modelAndView;
    }
}
