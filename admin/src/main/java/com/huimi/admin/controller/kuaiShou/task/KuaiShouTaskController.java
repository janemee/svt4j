package com.huimi.admin.controller.kuaiShou.task;
...
public class KuaiShouTaskController extends BaseController {
    @Resource
    ...
    public String list() {
        return getAdminTemplate("kuaiShou/task/list");
    }

    @RequestMapping("task/superHotList")
    public String superHotList() {
        return getAdminTemplate("kuaiShou/task/taskSuperHotList");
    }
    ...
    public ModelAndView detailList(String ids) {
        ...
        modelAndView.setViewName("kuaiShou/task/taskDetails");
        return modelAndView;
    }
    ...
    public ModelAndView hotTaskDetails(String ids) {
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.addObject("ids", ids);
        modelAndView.setViewName("kuaiShou/task/hotTaskDetails");
        return modelAndView;
    }
    ...
    public ModelAndView yangHao() {
        ...
        modelAndView.setViewName("kuaiShou/task/yangHao");
        return modelAndView;
    }
    ...
    public ModelAndView privateLetter() {
        ...
        modelAndView.addObject("equipmentGroups", equipmentGroups);
        modelAndView.addObject("commentTemplate", commentTemplate);
        modelAndView.setViewName("kuaiShou/task/privateLetter");
        return modelAndView;
    }
    ...
    public ModelAndView oneKeyExplosivePowder() {
        ...
        modelAndView.addObject("equipmentGroups", equipmentGroups);
        modelAndView.addObject("commentTemplate", commentTemplate);
        modelAndView.setViewName("kuaiShou/task/oneKeyExplosivePowder");
        return modelAndView;
    }
    ...
    public ModelAndView over() {
        ...
        modelAndView.addObject("equipmentList", equipmentList);
        modelAndView.addObject("equipmentGroups", equipmentGroups);
        modelAndView.setViewName("kuaiShou/task/over");
        return modelAndView;
    }
    ...
    public ModelAndView taskType(String taskType) {
        ...
        if ("giveLightPlate".equals(taskType)) {
            ...
            List<Task> liveHot = taskService.findLiveHeart(AdminSessionHelper.getAdminId(), EnumConstants.PLAT_FROM_TYPE.KUAISHOU.value);
        ...
        modelAndView.setViewName("kuaiShou/task/" + taskType);
        return modelAndView;
    }
    ...
    public ModelAndView equipmentSome(String equipmentGroups) {
        ...
        modelAndView.addObject("equipmentGroups", equipmentGroups);
        modelAndView.setViewName("kuaiShou/task/equipmentToGroups");
        return modelAndView;
    }
