 ...
 *
 * @author fengting
 * @version 创建时间：2018年4月17日 上午10:10:02
 */
public class GoogleAuthenticator {
    ...
    private static final String SEED = "Ib3DQEBAQUAA4GNADCBiQKBgQDOFiiBex2OjJwn0mPMMHn8HBcKgDk8xn2nTmD1mouiOLK8L0UeEjGPRwFPEF";
    // Java实现随机数算法
    private static final String RANDOM_NUMBER_ALGORITHM = "SHA1PRNG";
    // 最多可偏移的时间
    private int window_size = 3; // default 3 - max 17
    ...
    public static String getQRBarcode(String user, String secret) {
        String format = "otpauth://totp/%s?secret=%s&issuer=GoldFinger";
    ...
    public static boolean verify(String code, String secret) {
        if (StrUtil.isBlank(code) || StrUtil.isBlank(secret)) {
            return false;
        }
        long t = System.currentTimeMillis();
        GoogleAuthenticator ga = new GoogleAuthenticator();
        ga.setWindowSize(5);
        return ga.check_code(secret, Long.parseLong(code), t);
    }
}