...
//        //扫码跳转路径
//        String smUrl = "http://douguanjia.oss-cn-hangzhou.aliyuncs.com/apk/1597713310.apk";
//        //二维码保存路径
//        String qrCodeUrl = "G:\\img\\QRcodeImg\\";
//        Integer size = 500;
//        String imgUrl = "G:\\img\\kk.jpg";
//        File file = QRCodeUtil.zxingCodeCreate(smUrl, qrCodeUrl, size, imgUrl);
//        file.delete();
