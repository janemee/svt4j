...
public class SensitiveInfoUtils {
     ...
     * @return 脱敏后的数据
     */
    public static String patternReplace(final String context, DataMaskEnum pattern, String replaceChar) {
        if(DataMaskEnum.EMAIL == pattern){
            return MaskUtils.getMaskToEmail(context);
        }
        if(DataMaskEnum.USERNAME == pattern){
            return MaskUtils.getMaskToName(context);
        }
        return context;
    }
