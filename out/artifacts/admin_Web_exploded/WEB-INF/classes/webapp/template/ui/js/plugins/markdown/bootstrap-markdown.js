...
! function ($) {
    ...
    Markdown.prototype = {
        ...
        showEditor: function () {
            ...
            if (this.$editor == null) {
                ...
                if (options.savable) {
                    ...
                    editorFooter.append('<button class="btn btn-success" data-apis="' + ns + '" data-handler="' + saveHandler + '"><i class="icon icon-white icon-ok"></i> ' + this.__localize('Save') + '</button>')
                ...
                this.$editor.on('click', '[data-apis="bootstrap-markdown"]', $.proxy(this.__handle, this))
                ...
                if (this.eventSupported('keydown') && typeof jQuery.hotkeys === 'object') {
                    editorHeader.find('[data-apis="bootstrap-markdown"]').each(function () {
                        var $button = $(this),
        ...
        hidePreview: function () {
            ...
            var container = this.$editor.find('div[data-apis="markdown-preview"]')
            ...
            $(document).find('.md-editor').each(function () {
                if ($(this).attr('id') != editor.attr('id')) {
                    ...
                    if (attachedMarkdown = $(this).find('textarea').data('markdown'),
                        ...
                        attachedMarkdown = $(this).find('div[data-apis="markdown-preview"]').data('markdown')
                    }
    ...
    var blurNonFocused = function (e) {
        ...
        $(document).find('.md-editor').each(function () {
            var $this = $(this),
                ...
                $this.find('div[data-apis="markdown-preview"]').data('markdown')
