		...
		$('#form').validate({
			...
			submitHandler: function(form) {
				...
				$.ajax({
					...
					async: false,
					data: $(form).serialize(),
					url: "/modules/user/identify/doRealnameVerify",
					success: function(data) {
						if (data.result) {
                            ...
                            parent.notifications('success',successMsg);
						} else {
	...
	var editIdentify = function() {
		$('#form').validate({
			...
			rules: {
				...
				"userIdentify.mobile_phone_status": {
					required: true
				},
				"user.email": {
					required: true,
			...
			submitHandler: function(form) {
				...
				$.ajax({
					...
					async: false,
					data: $(form).serialize(),
					url: "/modules/user/identify/doEditIdentify",
					success: function(data) {
						if (data.result) {
							window.parent[winname].$(jqGridId).jqGrid('setGridParam', {
								url: dataUrl,
