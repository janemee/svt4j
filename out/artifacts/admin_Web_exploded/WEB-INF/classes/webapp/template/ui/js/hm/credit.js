var CreditJs = function () {
    var handleValidation = function() {
            $('#form').validate({
                ...
                ignore: "",
                rules: {
                	"customercreditapply.amount" : {
						required : true,
					},
					"customercreditapply.addtime":{
						required : true,
					},
					"customercreditapply.content":{
						required : true,
						maxlength : 100
					},
					"customercreditapply.verifyremark":{
						required : true,
						maxlength : 100
					},
					"customercreditapply.remark":{
						maxlength : 150
					},
                },
                ...
                submitHandler: function (form) {
	                ...
	                $.ajax({
	             	   	...
	             	   	async:false,
	             	   	data:$(form).serialize(),
	             	   	url: "/modules/credit/doCreditVerify",
